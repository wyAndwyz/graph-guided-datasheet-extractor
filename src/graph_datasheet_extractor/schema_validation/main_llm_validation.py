...
from graph_datasheet_extractor.schema_validation.llm_validation_runner import (
    run_llm_schema_validation,
)


def print_report_summary(report: dict) -> None:
    """Print a compact LLM-assisted validation summary to the terminal."""
    summary = report.get("summary", {})

    print("\n=== LLM-assisted Schema Validation Summary ===")
    ...
    print("\nReport file:")
    print("outputs/validation_reports/llm_schema_validation_report.json")

    print("\nGenerated Cypher query log:")
    print("outputs/validation_reports/llm_generated_cypher_queries.json")


def main() -> int:
    """Run LLM-assisted schema validation from a dedicated entry point."""
    try:
        ...
        print("\nLLM-assisted schema validation failed with an exception:")
        print(str(exc))

        debug_report_path = Path("outputs/validation_reports/llm_schema_validation_error.json")
